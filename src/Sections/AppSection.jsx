  ...
  return (
    <section className="max-w-7xl mx-auto border-b-2 pb-16 h-full" id="app">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="links h-auto w-[90%] mx-auto lg:w-full bg-yellow-100 rounded-[50px] p-6 lg:p-20 flex flex-col lg:flex-row justify-between items-center"
      >
        <div className="text-content lg:w-2/3 lg:mb-0 px-4 sm:px-8">
          <h3 className="lg:text-2xl text-xl mb-4 sm:mb-8 lg:mt-0 mt-2 font-bold text-gray-700">
            Our App is Live Now!
          </h3>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="image-content lg:w-1/3 mt-10 lg:mt-0 hidden lg:block"
        >
